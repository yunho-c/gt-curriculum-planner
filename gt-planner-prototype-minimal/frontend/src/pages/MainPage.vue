<template>
  ...
  <button @click="$refs.asdf.draw(d1)">1</button>
  <button @click="$refs.asdf.draw(d2)">2</button>
  <button @click="$refs.asdf.draw(d3)">3</button>
  <button @click="$refs.asdf.draw(d4)">4</button>
